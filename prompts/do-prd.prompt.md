...
2. One or more **Mermaid diagrams** describing user journeys, data flows, or system components.
---
### YOUR OUTPUT 
Generate a **structured PRD** using the following format and tone:
...
## 4. User Flows
Interpret each Mermaid diagram and describe:
- the key actors,
- main flow steps,
- decision points,
...
- Automatically extract flow names and nodes from Mermaid diagrams.
...
- place the file inside docs/ folder with the name main-prd.md
---